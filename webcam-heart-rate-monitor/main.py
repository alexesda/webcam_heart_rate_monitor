...
if len(sys.argv) != 2:
    ...
    originalVideoWriter.open(originalVideoFilename, cv2.VideoWriter_fourcc(*'jpeg'), videoFrameRate, (realWidth, realHeight), True)

outputVideoFilename = "output.mov"
outputVideoWriter = cv2.VideoWriter()
outputVideoWriter.open(outputVideoFilename, cv2.VideoWriter_fourcc(*'jpeg'), videoFrameRate, (realWidth, realHeight), True)
